...
export default function Dashboard(){
  ...
  <button onClick={runEngine} disabled={running} className="bg-gradient-to-r from-theme-peach to-theme-blue text-slate-900 px-5 py-2.5 rounded-lg text-sm font-bold transition-all shadow-sm hover:shadow-md disabled:opacity-50 flex gap-2 items-center border-none">
